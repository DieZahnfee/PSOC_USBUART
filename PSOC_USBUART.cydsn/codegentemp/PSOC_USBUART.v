...
// ADC_DelSig_v3_20(ADC_Alignment=1, ADC_Alignment_Config2=0, ADC_Alignment_Config3=0, ADC_Alignment_Config4=0, ADC_Charge_Pump_Clock=true, ADC_Clock=1, ADC_CLOCK_FREQUENCY=1523712, ADC_Input_Mode=0, ADC_Input_Range=4, ADC_Input_Range_Config2=4, ADC_Input_Range_Config3=4, ADC_Input_Range_Config4=4, ADC_Power=1, ADC_Reference=5, ADC_Reference_Config2=0, ADC_Reference_Config3=0, ADC_Reference_Config4=0, ADC_Resolution=20, ADC_Resolution_Config2=16, ADC_Resolution_Config3=16, ADC_Resolution_Config4=16, Clock_Frequency=64000, Comment_Config1=Default Config, Comment_Config2=Second Config, Comment_Config3=Third Config, Comment_Config4=Fourth Config, Config1_Name=CFG1, Config2_Name=CFG2, Config3_Name=CFG3, Config4_Name=CFG4, Configs=1, Conversion_Mode=2, Conversion_Mode_Config2=2, Conversion_Mode_Config3=2, Conversion_Mode_Config4=2, Enable_Vref_Vss=false, EnableModulatorInput=false, Input_Buffer_Gain=2, Input_Buffer_Gain_Config2=1, Input_Buffer_Gain_Config3=1, Input_Buffer_Gain_Config4=1, Input_Buffer_Mode=2, Input_Buffer_Mode_Config2=1, Input_Buffer_Mode_Config3=1, Input_Buffer_Mode_Config4=1, Ref_Voltage=1.25, Ref_Voltage_Config2=1.024, Ref_Voltage_Config3=1.024, Ref_Voltage_Config4=1.024, rm_int=false, Sample_Rate=93, Sample_Rate_Config2=10000, Sample_Rate_Config3=10000, Sample_Rate_Config4=10000, Start_of_Conversion=0, Vdda_Value=5, CY_API_CALLBACK_HEADER_INCLUDE=#include "cyapicallbacks.h", CY_COMPONENT_NAME=ADC_DelSig_v3_20, CY_CONST_CONFIG=true, CY_CONTROL_FILE=<:default:>, CY_DATASHEET_FILE=<:default:>, CY_FITTER_NAME=ADC_DelSig, CY_INSTANCE_SHORT_NAME=ADC_DelSig, CY_MAJOR_VERSION=3, CY_MINOR_VERSION=20, CY_PDL_DRIVER_NAME=, CY_PDL_DRIVER_REQ_VERSION=, CY_PDL_DRIVER_SUBGROUP=, CY_PDL_DRIVER_VARIANT=, CY_REMOVE=false, CY_SUPPRESS_API_GEN=false, CY_VERSION=PSoC Creator  4.0, INSTANCE_NAME=ADC_DelSig, )
...
// OpAmp_v1_90(Mode=0, Power=1, CY_API_CALLBACK_HEADER_INCLUDE=#include "cyapicallbacks.h", CY_COMPONENT_NAME=OpAmp_v1_90, CY_CONST_CONFIG=true, CY_CONTROL_FILE=<:default:>, CY_DATASHEET_FILE=<:default:>, CY_FITTER_NAME=OPAMP, CY_INSTANCE_SHORT_NAME=OPAMP, CY_MAJOR_VERSION=1, CY_MINOR_VERSION=90, CY_PDL_DRIVER_NAME=, CY_PDL_DRIVER_REQ_VERSION=, CY_PDL_DRIVER_SUBGROUP=, CY_PDL_DRIVER_VARIANT=, CY_REMOVE=false, CY_SUPPRESS_API_GEN=false, CY_VERSION=PSoC Creator  4.0, INSTANCE_NAME=OPAMP, )
...
// IDAC8_v2_0(Current=128, Data_Source=0, Hardware_Enable=false, IDAC_Range=4, IDAC_Speed=0, Initial_Value=128, Polarity=4, Strobe_Mode=0, CY_API_CALLBACK_HEADER_INCLUDE=#include "cyapicallbacks.h", CY_COMPONENT_NAME=IDAC8_v2_0, CY_CONST_CONFIG=true, CY_CONTROL_FILE=<:default:>, CY_DATASHEET_FILE=<:default:>, CY_FITTER_NAME=IDAC8, CY_INSTANCE_SHORT_NAME=IDAC8, CY_MAJOR_VERSION=2, CY_MINOR_VERSION=0, CY_PDL_DRIVER_NAME=, CY_PDL_DRIVER_REQ_VERSION=, CY_PDL_DRIVER_SUBGROUP=, CY_PDL_DRIVER_VARIANT=, CY_REMOVE=false, CY_SUPPRESS_API_GEN=false, CY_VERSION=PSoC Creator  4.0, INSTANCE_NAME=IDAC8, )
module IDAC8_v2_0_3 (
    strobe,
    data,
    iOut,
...
module top ;
	...
	wire [0:0] tmpOE__Analog_In_Pos_net;
	wire [0:0] tmpFB_0__Analog_In_Pos_net;
	wire [0:0] tmpIO_0__Analog_In_Pos_net;
	wire [0:0] tmpINTERRUPT_0__Analog_In_Pos_net;
	electrical [0:0] tmpSIOVREF__Analog_In_Pos_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("77715107-f8d5-47e5-a629-0fb83101ac6b"),
		  ...
		  .input_buffer_sel(2'b00))
		Analog_In_Pos
		 (.oe(tmpOE__Analog_In_Pos_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__Analog_In_Pos_net[0:0]}),
		  .analog({Net_54}),
		  .io({tmpIO_0__Analog_In_Pos_net[0:0]}),
		  .siovref(tmpSIOVREF__Analog_In_Pos_net),
		  .interrupt({tmpINTERRUPT_0__Analog_In_Pos_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Analog_In_Pos_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__Analog_In_Neg_net;
	wire [0:0] tmpFB_0__Analog_In_Neg_net;
	wire [0:0] tmpIO_0__Analog_In_Neg_net;
	wire [0:0] tmpINTERRUPT_0__Analog_In_Neg_net;
	electrical [0:0] tmpSIOVREF__Analog_In_Neg_net;

	cy_psoc3_pins_v1_10
		#(.id("ec112090-aa74-4470-b648-f405a17ffddc"),
		  .drive_mode(3'b000),
		  .ibuf_enabled(1'b0),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		Analog_In_Neg
		 (.oe(tmpOE__Analog_In_Neg_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__Analog_In_Neg_net[0:0]}),
		  .analog({Net_69}),
		  .io({tmpIO_0__Analog_In_Neg_net[0:0]}),
		  .siovref(tmpSIOVREF__Analog_In_Neg_net),
		  .interrupt({tmpINTERRUPT_0__Analog_In_Neg_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Analog_In_Neg_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
    ...
    defparam R.comp_name = "Potentiometer_v1_0";
    defparam R.port_names = "T1, T2, W";
    defparam R.width = 3;
	...
	wire [0:0] tmpOE__Vref_source_net;
	wire [0:0] tmpFB_0__Vref_source_net;
	wire [0:0] tmpIO_0__Vref_source_net;
	wire [0:0] tmpINTERRUPT_0__Vref_source_net;
	electrical [0:0] tmpSIOVREF__Vref_source_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("cc3bcd7e-5dc0-48ea-9bf6-6aa082be1ada"),
		  ...
		  .input_buffer_sel(2'b00))
		Vref_source
		 (.oe(tmpOE__Vref_source_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__Vref_source_net[0:0]}),
		  .analog({Net_91}),
		  .io({tmpIO_0__Vref_source_net[0:0]}),
		  .siovref(tmpSIOVREF__Vref_source_net),
		  .interrupt({tmpINTERRUPT_0__Vref_source_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Vref_source_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
    ...
    defparam IDAC8.Initial_Value = 128;
    defparam IDAC8.Strobe_Mode = 0;

	wire [0:0] tmpOE__Vref_sink_net;
	wire [0:0] tmpFB_0__Vref_sink_net;
	wire [0:0] tmpIO_0__Vref_sink_net;
	wire [0:0] tmpINTERRUPT_0__Vref_sink_net;
	electrical [0:0] tmpSIOVREF__Vref_sink_net;

	cy_psoc3_pins_v1_10
		#(.id("f7603401-8c79-452e-b8db-3934aa103c1b"),
		  .drive_mode(3'b000),
		  .ibuf_enabled(1'b0),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		Vref_sink
		 (.oe(tmpOE__Vref_sink_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__Vref_sink_net[0:0]}),
		  .analog({Net_87}),
		  .io({tmpIO_0__Vref_sink_net[0:0]}),
		  .siovref(tmpSIOVREF__Vref_sink_net),
		  .interrupt({tmpINTERRUPT_0__Vref_sink_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
